...
export const Navbar = () => {
  ...
  return (
    <Header>
      ...
      <NavbarComp>
        <ul>
          <LinkTodo objprops={objProps} to={"todo"} >To-Do List{objProps.notask ? <span></span> : objProps.somecompleted ? <span><FcApproval /></span> : <span><FcAbout /></span>}</LinkTodo>
          <LinkItem to={"pokemons"}>Pokemon</LinkItem>
        </ul>
      </NavbarComp>
    </Header>
  )
